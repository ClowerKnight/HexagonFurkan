...
namespace Hexagon
{
    public class GameManager : MonoBehaviour
    {
        ...
        [HideInInspector] 
        public int hexTypesCount;
        
        [SerializeField] 
        public List<Sprite> hexSprites;
        [SerializeField] 
        public BombWidget bombWidgetPrefab;
        [SerializeField] 
        public Hex hexPrefab;
        public HexPositionCalculator positionCalculator { get; private set; }
        
        [SerializeField] 
        private Vector2Int boardSize = new Vector2Int(8,9);
        [SerializeField] 
        private bool forceRewindAfterNoMatch = true;
        [SerializeField] 
        private LevelGenerator levelGenerator;
        [SerializeField] 
        private RandomHexCreator hexCreator;
        ...
        #region Start-IEnumerable-Initialize-Initialize
        private void Start()
        {
            Initialize();
        }
        ...
        #region IsThereAnyMoveLeft-Rotate-HandleMove-
        ...
        #region TriggerShift-TriggerGameOver-DestroyExplodedHexes-CalculateHexagons
        ...
        #region CreateHexGameObject-SetElementWithMoveAnimation-CalculateShifts-FindAllExplodedHexs-CheckMatchAllNeighbors
        ...
        #region CheckMatchNeighborClockwise-TriggerRestart
